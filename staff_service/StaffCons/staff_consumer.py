...
def main():
    ...
    channel.queue_bind(exchange='ProjectEX', queue=new_queue_name, routing_key='staff.new')
    channel.queue_bind(exchange='ProjectEX', queue=new_queue_name, routing_key='staff.changed')
